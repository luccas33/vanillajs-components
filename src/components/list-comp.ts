...
type ListComponent = {
    ...
    items: {value: number, index: number, isRemoved?: boolean}[]
}
...
function init(component: ListComponent) {
...
function createList(component: ListComponent) {
...
function createListItem(component: ListComponent, index: number) {
...
function sumValues(component: ListComponent) {
    let total = 0;
    component.items
